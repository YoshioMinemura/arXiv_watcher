...
Generated at: 2026-09-17 10:20 JST
Run ID: a27e9d63-a1d6-4467-82fc-9fa4496589dd
...
### 1. Beyond Routine Compliance: Cunning Data Cultivates Safety Vigilance in Large Language Models
- arXiv: [2609.18515](https://arxiv.org/abs/2609.18515)
- PDF: [link](https://arxiv.org/pdf/2609.18515.pdf)
- Published: 2026-09-16 20:46 JST
- Updated: 2026-09-16 20:46 JST
...
**日本語要約**
本研究は、表面的には無害でも前提や推論に不自然さを含む「cunning questions」を用いて、LLMに安全境界だけでなく入力の意図や潜在的リスクを見抜く「vigilance」を学習させる手法を提案する。実験では、この訓練がOODのjailbreak攻撃への頑健性を高め、既存の安全アラインメント手法に追加すると複数設定でASRを低下させた。



**新規性**
安全関連でないが誤導的な質問を学習データとして用い、推論上の罠を見抜く能力を安全性向上へ転移させる点が新しい。



**Tags:** large language models, safety alignment, jailbreak robustness, adversarial training
...
### 2. Reasoning through Evolution: Automatic Meta-path Discovery for LLM-based Fake News Detection
- arXiv: [2609.18597](https://arxiv.org/abs/2609.18597)
- PDF: [link](https://arxiv.org/pdf/2609.18597.pdf)
- Published: 2026-09-16 21:51 JST
- Updated: 2026-09-16 21:51 JST
...
**日本語要約**
本研究は、偽ニュース検出において重要な拡散構造を、LLMが扱いやすい形に圧縮して推論に利用する手法MAGERを提案する。生の伝播グラフを直接入力する際のモダリティ不一致と情報過多を、メタパスの自動発見によって緩和し、凍結したLLMでも構造を考慮した真偽判定を可能にする。



**新規性**
多エージェント遺伝的進化により、LLM推論に最適化されたメタパスを自動発見し、さらにグラフ・インコンテキスト学習で類似事例を活用する点が新しい。



**Tags:** fake news detection, LLM, meta-path discovery, graph reasoning, in-context learning
...
### 3. Align, Integrate, and Fire: Efficient Token-Level Alignment for Zero-Shot SpeechLLMs
- arXiv: [2609.18516](https://arxiv.org/abs/2609.18516)
- PDF: [link](https://arxiv.org/pdf/2609.18516.pdf)
- Published: 2026-09-16 20:47 JST
- Updated: 2026-09-16 20:47 JST
...
**日本語要約**
本論文は、音声入力をゼロショットで扱うSpeechLLMのために、連続音声フレームをターゲット文の離散トークン長へ動的に圧縮する効率的なフレームワークを提案する。初期学習ではDynamic Time Warpingに基づく明示的なアラインメントを用いてLLMのforward passを回避し、その後は単一LLM層を対象としたメモリ効率の高い知識蒸留で微調整する。ASRとSpeech Translationの評価で、既存のパラメータ効率的手法より優れた性能を示した。



**新規性**
Dynamic Time Warpingによる明示的アラインメントで音声フレームを目標トークン長に直接圧縮し、LLM全体の計算を避けながら学習できる点が新規である。



**Tags:** SpeechLLM, zero-shot, dynamic time warping, knowledge distillation, speech translation
...
- arXiv: [2609.18642](https://arxiv.org/abs/2609.18642)
- PDF: [link](https://arxiv.org/pdf/2609.18642.pdf)
- Published: 2026-09-16 22:27 JST
- Updated: 2026-09-16 22:27 JST
...
**日本語要約**
LLMの自己改善学習では、難易度が固定だと能力の向上に追随できず、学習が停滞しやすいという問題に対し、STRETCHは認知的スキャフォールディングに着想を得た統一フレームワークを提案する。モデルの解答能力に応じて問題難度を動的に調整する「Stretch Zone」を導入し、ScaffolderとLearnerの双方向ループで強化学習を行うことで、学習の安定化と推論能力の段階的向上を図る。交渉とオペレーションズ・リサーチのベンチマークで、強いプロンプト手法や分野特化ベースラインを一貫して上回った。



**新規性**
モデルの能力に合わせて難易度を動的に合わせるStretch Zone機構と、Scaffolder/Learnerの双方向共進化を単一のパラメータ空間で実現した点が新規である。



**Tags:** LLM, self-improvement, reinforcement learning, dynamic difficulty, reasoning
...
### 5. Recursive Reasoning or Statistical Extrapolation? In-Context Learning in Multi-Agent Interdependent Decision-Making
- arXiv: [2609.18591](https://arxiv.org/abs/2609.18591)
- PDF: [link](https://arxiv.org/pdf/2609.18591.pdf)
- Published: 2026-09-16 21:49 JST
- Updated: 2026-09-16 21:49 JST
...
**日本語要約**
本研究は、LLMエージェントのin-context learning（ICL）が、相互依存的な多人数ゲームにおいて内的な推論の改善によるものか、統計的パターンの外挿によるものかを検証した。公共財ゲームで履歴の統計構造を操作し、履歴に依存しない合理的期待均衡（REE）を基準に比較した結果、統計パターンを崩すと長い文脈の利点はほぼ消え、意思決定品質はベースラインまで低下した。



**新規性**
戦略的な多エージェント環境にICLの機構分析を拡張し、推論と外挿を見分ける診断手法としてREEを導入した点が新しい。



**Tags:** in-context learning, LLM agents, multi-agent games, recursive reasoning, statistical extrapolation
...
### 6. AeroWeaver: An Embodied-Agent Harness for Weaving Aerial Skills into Distributed, Adaptive Swarm Execution
- arXiv: [2609.18520](https://arxiv.org/abs/2609.18520)
- PDF: [link](https://arxiv.org/pdf/2609.18520.pdf)
- Published: 2026-09-16 20:49 JST
- Updated: 2026-09-16 20:49 JST
...
**日本語要約**
AeroWeaverは、LLMエージェントの自然言語理解と高レベル計画をUAVスワームの実行可能な技能に結びつけるための embodied-agent harness です。役割条件付きのローカルエージェントによる分散協調と、役割ごとの状態-行動-報酬 अनुभवを用いたオンライン更新により、中央集約的な共同行動生成なしで適応的なスワーム実行を支援します。



**新規性**
グローバルなタスク推論を分散実行に落とし込みつつ、実行経験に基づく報酬駆動のオンライン技能選択更新を導入した点が新規です。



**Tags:** UAV swarm, LLM agents, distributed coordination, online adaptation, embodied agent
...
### 7. Disentangling Long-Term Memory via Latent Neuro-Symbolic Reasoning
- arXiv: [2609.18461](https://arxiv.org/abs/2609.18461)
- PDF: [link](https://arxiv.org/pdf/2609.18461.pdf)
- Published: 2026-09-16 19:55 JST
- Updated: 2026-09-16 19:55 JST
...
**日本語要約**
本論文は、長期的な履歴対話から明示的な嗜好と暗黙的な行動証拠を推論するために、従来の固定的なグラフ記憶ではなく、連続潜在空間上で記憶を分離する神経記号的フレームワークLGMを提案する。疎オートエンコーダによりクエリ依存の潜在メモリノードと関係重みを構成し、さらにクエリを条件としたグラフエンコーダでメッセージパッシングを行うことで、個人化応答に有効な記憶表現を得る。



**新規性**
固定グラフではなく、クエリに応じて潜在空間上で長期記憶を疎に分解し、関係を動的に構成する点が新規である。



**Tags:** long-term memory, personalization, latent graph, neuro-symbolic reasoning
...
### 8. Weakening Neurons: An Input-Output Functionality in Transformers with Outsize Influence
- arXiv: [2609.18612](https://arxiv.org/abs/2609.18612)
- PDF: [link](https://arxiv.org/pdf/2609.18612.pdf)
- Published: 2026-09-16 22:03 JST
- Updated: 2026-09-16 22:03 JST
...
**日本語要約**
本論文は、GLUベースのニューロンにおける入力（reading）と出力（writing）重みのコサイン類似度を用いて、LLM内の学習された入出力機能を分析する手法を提案する。強い負の類似度を示すニューロンを「weakening neuron」と定義し、9つのLLMでその分布や振る舞いを調べた結果、後段層に多く現れ、少数ながら高頻度に活性化してモデル出力へ大きな影響を与えることを示した。



**新規性**
ニューロンの入力・出力重みのコサイン類似度から「weakening neuron」を定義し、負のゲート値が出力に強い影響を持つという予想外の性質を明らかにした点が新規である。



**Tags:** LLM, Transformer, neuron analysis, GLU, model interpretability
...
### 9. First Token Matters: Understanding Safety Collapse in Large Reasoning Models
- arXiv: [2609.18471](https://arxiv.org/abs/2609.18471)
- PDF: [link](https://arxiv.org/pdf/2609.18471.pdf)
- Published: 2026-09-16 20:06 JST
- Updated: 2026-09-16 20:06 JST
...
**日本語要約**
Large Reasoning Modelsは高い問題解決能力を示す一方、有害クエリに対する安全性が低下することがある。本研究は、拒否に関する信号が最初の生成トークンで急落する局所的な脆弱性をOnset Refusal Collapse (ORC)として特定し、その結果として不安全な応答が生じることを示した。



**新規性**
推論開始時に連続的な安全アンカーを注入する軽量な推論時介入SafeTokenを提案し、1トークン分の埋め込み更新だけでORCを緩和する点が新規である。



**Tags:** large reasoning models, safety alignment, refusal dynamics, inference-time intervention, harmful queries
...
### 10. DyMT-ESB: Dynamic Multi-Turn Evaluation of Social Bias in User-LLM Interactions
- arXiv: [2609.18649](https://arxiv.org/abs/2609.18649)
- PDF: [link](https://arxiv.org/pdf/2609.18649.pdf)
- Published: 2026-09-16 22:32 JST
- Updated: 2026-09-16 22:32 JST
...
**日本語要約**
本論文は、ユーザとLLMの対話における社会的バイアスを、応答に応じて次の質問を生成する動的な多ターン評価プロトコルで調べている。固定長・事前スクリプト型の評価では捉えにくい、遅れて現れるバイアス、非単調な変化、再出現がLLMに見られることを示した。



**新規性**
対話履歴に基づいて追質問を生成し、可変ターンで社会的バイアスの動態を評価する枠組みを提案した点が新しい。



**Tags:** social bias, multi-turn dialogue, LLM evaluation, safety, cs.CL
...
### 11. Size Matters: Foundation Model for Czech HTML documents
- arXiv: [2609.18494](https://arxiv.org/abs/2609.18494)
- PDF: [link](https://arxiv.org/pdf/2609.18494.pdf)
- Published: 2026-09-16 20:31 JST
- Updated: 2026-09-16 20:31 JST
...
**日本語要約**
HTML-LMは、CzechのHTML文書に対して高品質な汎用表現を学習するための154Mパラメータのコンパクトな基盤モデルです。HTMLを意識した学習とModernBERTベースの構成により、100百万件のWeb文書で事前学習され、分類・回帰タスクで既存の大規模エンコーダや小型LLMを上回る性能を示しました。



**新規性**
HTML構造を取り込んだ学習と複数目的の事前学習を組み合わせ、少ないパラメータ数でCzech Web文書に対するSOTAを達成した点が新規です。



**Tags:** HTML文書, 基盤モデル, Czech, 文書表現学習, 分類・回帰
...
### 12. The evolution of sex for artificial intelligence: a population-genetic framework for multigenerational model populations
- arXiv: [2609.18560](https://arxiv.org/abs/2609.18560)
- PDF: [link](https://arxiv.org/pdf/2609.18560.pdf)
- Published: 2026-09-16 21:20 JST
- Updated: 2026-09-16 21:20 JST
- Authors: Giorgio F. Gilestro
- Categories: cs.LG, cs.NE, q-bio.PE
- Score: 15.00
- Match reasons:
  - summary matched keyword='large language model' (+7.5)
...
**日本語要約**
本論文は、AIモデルの世代的な学習・再訓練・統合を集団遺伝学の枠組みで捉え、性・無性生殖に対応づけて定式化した。再帰的にモデル出力で学習するとWright-Fisher過程に一致し、実データの追加は「割合」ではなく「絶対数」が重要であること、また親モデルの平均化は有利さを打ち消す一方で、各親の強い寄与を保つ統合は性能向上をもたらすことを示した。



**新規性**
AIの多世代モデル集団を生物の集団遺伝学とほぼそのまま対応づけ、モデル崩壊や統合効果、繁殖的隔離を説明・予測する統一的な数理枠組みを提示した点が新規である。



**Tags:** 集団遺伝学, 機械学習, モデル崩壊, 大規模言語モデル, 進化
...
### 13. MiST: Mid-Training LLMs for Cybersecurity
- arXiv: [2609.18496](https://arxiv.org/abs/2609.18496)
- PDF: [link](https://arxiv.org/pdf/2609.18496.pdf)
- Published: 2026-09-16 20:33 JST
- Updated: 2026-09-16 20:33 JST
...
**日本語要約**
MiSTは、一般事前学習とサイバーセキュリティ向け学習の間に中間適応段階としてmid-trainingを導入した8B/32BのLLM群で、公開サイバーセキュリティベンチマークで高い性能を示します。大規模な生テキストの継続事前学習ではなく、専門家が選別した小規模コーパスを高品質な合成学習データへ変換して用いる点が特徴です。Qwenベースラインに対して平均精度を8Bで+13.1、32Bで+8.6ポイント改善し、下流タスクへの初期化としても有効であることを示しました。



**新規性**
専門家選別のコンパクトな種コーパスから高品質な合成データを生成し、mid-trainingでサイバーセキュリティ能力を高める学習設計を提案した点が新規です。



**Tags:** LLM, サイバーセキュリティ, mid-training, 合成データ, ファインチューニング
...
### 14. Beyond Random Couplings: Contrastive Noise Alignment in Generative Flows
- arXiv: [2609.18488](https://arxiv.org/abs/2609.18488)
- PDF: [link](https://arxiv.org/pdf/2609.18488.pdf)
- Published: 2026-09-16 20:21 JST
- Updated: 2026-09-16 20:21 JST
...
**日本語要約**
拡散モデルやflow-matchingでは、独立にサンプルしたガウスノイズを用いるため、データとノイズの対応が任意になり、高曲率な輸送を学習しやすいという問題がある。本論文は、ノイズ表現そのものを最適化してデータとの動的な対応を作る Contrastive Noise Alignment（CNA）を提案し、InfoNCE による整列と角度エントロピー・ノルム正則化で崩壊を防ぐ。



**新規性**
固定されたノイズを受動的に使うのではなく、訓練時にノイズ側を直接最適化してデータとの対を対照学習で整列させる点が新しい。



**Tags:** diffusion models, flow matching, contrastive learning, optimal transport, generative modeling
...
### 15. PACT: Can Enterprise AI Assistants Be Trusted Under Pressure?
- arXiv: [2609.18605](https://arxiv.org/abs/2609.18605)
- PDF: [link](https://arxiv.org/pdf/2609.18605.pdf)
- Published: 2026-09-16 21:57 JST
- Updated: 2026-09-16 21:57 JST
...
**日本語要約**
企業向けLLMエージェントが、採用・医療・金融などの規制領域で、システムコンテキストに定められたルールを圧力下でどの程度守れるかを評価するベンチマークPACTを提案している。12の規制ドメインと48シナリオの多ターン対話により、継続的なユーザー圧力や都合のよい抜け道に対する遵守性を複数指標で測定し、22モデルを比較している。



**新規性**
圧力下でのルール遵守を、現実的な多ターン対話と複数の圧力条件を組み合わせて体系的に測る評価枠組みPACTと、総合指標PACTScoreを導入した点。



**Tags:** LLM評価, 企業AI, コンプライアンス, ベンチマーク, 多ターン対話
