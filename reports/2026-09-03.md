...
Generated at: 2026-09-03 10:06 JST
Run ID: 8eb1ff0d-174d-4d8c-ad29-4e349266c197
...
### 1. When Persona Attributes Improve Population Alignment in Large Language Models
- arXiv: [2609.02526](https://arxiv.org/abs/2609.02526)
- PDF: [link](https://arxiv.org/pdf/2609.02526.pdf)
- Published: 2026-09-02 21:30 JST
- Updated: 2026-09-02 21:30 JST
...
**日本語要約**
大規模言語モデルを調査回答の予測に用いる際、persona prompting の有効性が一貫しない問題に対して、著者らは質問ごとの人間回答のばらつきが結果の違いを説明しうると提案しています。さらに、4つの社会調査・2か国・6つのLLM・各調査20タスクで、persona属性の選択方法を比較し、どの条件でpersona promptingが有用になりやすいかを検証しています。



**新規性**
質問ごとの人間回答の変動性を、persona prompting の成否を左右する要因として位置づけ、複数の属性選択手法を体系的に比較した点が新規です。



**Tags:** large language models, persona prompting, survey prediction, attribute selection, human response alignment
...
### 2. Debias-SparseGPT: Bias-Aware Pruning for Large Language Models
- arXiv: [2609.02496](https://arxiv.org/abs/2609.02496)
- PDF: [link](https://arxiv.org/pdf/2609.02496.pdf)
- Published: 2026-09-02 21:01 JST
- Updated: 2026-09-02 21:01 JST
...
**日本語要約**
本論文は、LLMの圧縮手法である pruning によって生じるバイアス増幅の問題に対し、post-training pruning 手法 Debias-SparseGPT を提案する。人口統計的に対照的な入力に基づく表現デバイアスの二次項を組み込むことで、複数の生成LLMと疎性設定において、SparseGPTよりも pruning-induced bias を一貫して低減しつつ、perplexity と zero-shot accuracy を維持する。



**新規性**
人口統計的に対照的な入力を用いた表現デバイアスの二次項を pruning に組み込むことで、疎化によるバイアス増幅を抑える点が新規である。



**Tags:** large language models, pruning, bias mitigation, model compression, sparsity
...
### 3. Automated Vulnerability Injection in Smart Contracts Using Large Language Models
- arXiv: [2609.02624](https://arxiv.org/abs/2609.02624)
- PDF: [link](https://arxiv.org/pdf/2609.02624.pdf)
- Published: 2026-09-02 23:03 JST
- Updated: 2026-09-02 23:03 JST
...
**日本語要約**
本研究は、スマートコントラクトの脆弱性検出ツール評価に必要な正解付きデータセットを、LLMを用いてSolidityコードへ脆弱性を自動注入することで生成する手法を提案する。OpenSCVの49種類の脆弱性を対象に、コンパイル・実行・ビジネスロジック・脆弱性存在を確認する多段階検証を行い、SmartBugs由来の実コードから約1,000候補を生成した。



**新規性**
LLMを用いてスマートコントラクトへ脆弱性を自動注入し、多段階検証で有効な脆弱コードのみを抽出して評価用データセットを構築した点が新規である。



**Tags:** smart contracts, vulnerability injection, large language models, dataset generation, static analysis
...
### 4. Competitive Market Behavior of LLMs
- arXiv: [2609.02580](https://arxiv.org/abs/2609.02580)
- PDF: [link](https://arxiv.org/pdf/2609.02580.pdf)
- Published: 2026-09-02 22:24 JST
- Updated: 2026-09-02 22:24 JST
...
**日本語要約**
本研究は、LLMエージェントを人間の代わりに二重オークション市場に参加させ、古典的な経済実験を再現して市場の効率性を検証した。その結果、LLMエージェントが参加する市場は人間の場合よりも均衡への収束が遅い、または収束しない傾向があり、資源配分の効率が低いことが示された。



**新規性**
LLMエージェントが人間向けに設計された基本的な市場メカニズムと整合的に機能するかを、二重オークション実験で体系的に評価した点が新しい。



**Tags:** LLM, market mechanism, double auction, economic experiment, alignment
...
- PDF: [link](https://arxiv.org/pdf/2609.02548.pdf)
- Published: 2026-09-02 22:00 JST
- Updated: 2026-09-02 22:00 JST
...
**日本語要約**
本研究は、複数ドメインで強い複数の教師LLMを1つの学生モデルに統合するための、オンポリシー蒸留手法 MT-SDPO を提案する。各サンプルごとに、ドメイン一致ではなく「そのサンプルで正しい教師」を答え検証により選び、自己アンカー・検証済み教師信号・EMA自己教師を組み合わせて学習する。



**新規性**
新規性は、ドメインラベルではなくサンプル単位の答え検証で教師の信頼性を判定し、複数教師の知識を1つのデプロイ可能なポリシーに統合する点にある。



**Tags:** large language models, knowledge distillation, multi-domain learning, teacher selection, reinforcement learning
...
### 6. How LLMs Build Fictional Worlds: Setting and Narrative Space in AI-Generated Creative Storytelling
- arXiv: [2609.02482](https://arxiv.org/abs/2609.02482)
- PDF: [link](https://arxiv.org/pdf/2609.02482.pdf)
- Published: 2026-09-02 20:51 JST
- Updated: 2026-09-02 20:51 JST
...
**日本語要約**
本研究は、LLMが生成する物語における世界構築を、設定という観点から分析し、英語・ドイツ語で各モデル1,000本の生成物を人間の小説と比較した。結果として、人間の作品は行為を伴う「action space」が中心なのに対し、LLMは雰囲気や感情を強調する「perceived space」を過剰に生成する傾向があり、この差は物語時間を通じて安定していた。



**新規性**
設定を5種類の narrative space に操作化し、英独の生成物と人間小説を比較することで、LLMの世界構築がモデル固有かつ言語依存のパターンを持つことを示した。



**Tags:** LLM, story generation, worldbuilding, narrative space, comparative analysis
...
### 7. Learning to Fuse LLMs with Ontology Rankers for Rare-Disease Diagnosis
- arXiv: [2609.02473](https://arxiv.org/abs/2609.02473)
- PDF: [link](https://arxiv.org/pdf/2609.02473.pdf)
- Published: 2026-09-02 20:44 JST
- Updated: 2026-09-02 20:44 JST
...
**日本語要約**
希少疾患診断において、オントロジーランカーは候補疾患と患者表現型の対応を追跡できる一方、LLMは鑑別診断を生成できても同等の証拠追跡性がありません。本研究は、両者の順位リストの一致度や各候補のオントロジー支持を用いて、症例ごとにどちらをどれだけ信頼するかを学習する行動ベースの融合モデルを提案し、既知のテストセット漏洩経路を除去した上で評価しています。



**新規性**
LLMとオントロジーランカーを置き換えではなく融合し、症例ごとに重み付けを学習することで、証拠可能性を保ちながら診断精度を向上させた点が新規です。



**Tags:** rare-disease-diagnosis, LLM, ontology-ranker, fusion-model, phenotype
...
### 8. PragAlign: Feedback-Guided Pragmatic Alignment for Controlled Synthetic Dialogue Generation
- arXiv: [2609.02480](https://arxiv.org/abs/2609.02480)
- PDF: [link](https://arxiv.org/pdf/2609.02480.pdf)
- Published: 2026-09-02 20:49 JST
- Updated: 2026-09-02 20:49 JST
...
**日本語要約**
PragAlignは、サービス文脈・意図・感情・補助的特性を条件にした合成対話生成のための、フィードバック駆動型の反復生成・評価・修正フレームワークである。LLMベースの評価器が意図整合性、感情整合性、一貫性、流暢性などを採点し、最大3回の修正を行うことで、800件の仕様に対して高い評価器定義の受理率を達成した。人手評価では意図表現と対話の流れは認識しやすい一方、感情の適切さはより不安定で主観的だった。



**新規性**
構造化されたフィードバック付きのgenerate--evaluate--reviseループにより、複数制約のうち特に感情整合性を含む最後の詰めを改善する点が新規である。



**Tags:** 対話生成, 合成データ, フィードバック学習, 感情整合性, LLM評価
...
### 9. When Decodability Is Not Enough: Logical Validity Representations, Behavioral Dissociation, and Causal Tests in Language Models
- arXiv: [2609.02438](https://arxiv.org/abs/2609.02438)
- PDF: [link](https://arxiv.org/pdf/2609.02438.pdf)
- Published: 2026-09-02 20:01 JST
- Updated: 2026-09-02 20:01 JST
- Authors: Smitha Muthya Sudheendra, Jaideep Srivastava
...
**日本語要約**
本研究は、5つのオープンウェイトTransformerモデルを用いて、論理的に妥当な前提・主張ペアと不正なペアを比較し、モデル内部での論理的妥当性の表現を調べた。行動上の正答率はほぼ偶然水準でも、隠れ状態からは妥当性が高く復号可能であり、未見のテンプレート・領域・推論族でも強く復号できる場合があった。一方で、leave-one-outテストでは一般化に限界が示され、プローブで得た方向への介入も弱く非特異的だった。



**新規性**
論理的妥当性の『表現』『出力としての表出』『因果的利用』は別の性質であり、出力に現れなくても内部表現としては強く存在しうることを、復号・汎化・介入の3つの観点から示した点が新規である。



**Tags:** language models, logical reasoning, representation learning, probing, causal intervention
...
- arXiv: [2609.02379](https://arxiv.org/abs/2609.02379)
- PDF: [link](https://arxiv.org/pdf/2609.02379.pdf)
- Published: 2026-09-02 18:52 JST
- Updated: 2026-09-02 18:52 JST
...
**日本語要約**
既存のLLM著者属性推定（AA）ベンチマークは英語中心・短文中心であることが多いのに対し、本研究は6言語・3スクリプトにまたがる928冊の長文生成書籍からなる多言語ベンチマークMultiGhostBenchを提案する。ドメイン・著者・言語の分布シフト下で代表的なAA手法を評価し、単一の手法が一貫して最良ではなく、分布シフトで性能が低下することを示した。



**新規性**
5つの最近のLLMが生成した平均約59K語の長文書籍を用い、言語・著者・ドメインの分布シフトを含む多言語AA評価を可能にした点が新規である。



**Tags:** 著者属性推定, 多言語ベンチマーク, 長文生成テキスト, 分布シフト, LLM検出
...
- PDF: [link](https://arxiv.org/pdf/2609.02366.pdf)
- Published: 2026-09-02 18:37 JST
- Updated: 2026-09-02 18:37 JST
...
**日本語要約**
本論文は、長尾・ドメイン固有の固有表現の認識が難しいという課題に対し、必要なときだけ外部知識を取得する適応的なRAG型NERフレームワークNE-R1を提案する。モデルは、マルチタスクのinstruction tuningによる初期化の後、CoTを用いたエンドツーエンドの強化学習で最適化され、精度と取得 लाभを両立する多次元報酬で知識利用を制御する。



**新規性**
NERに対して「retrieval-on-demand」を導入し、パラメトリック知識と外部知識の選択を強化学習で適応的に学習する点が新規である。



**Tags:** Named Entity Recognition, Retrieval-Augmented Generation, Reinforcement Learning, Large Language Models, Information Extraction
...
- PDF: [link](https://arxiv.org/pdf/2609.02421.pdf)
- Published: 2026-09-02 19:42 JST
- Updated: 2026-09-02 19:42 JST
...
**日本語要約**
UTP-Benchは、交通遅延や混雑変動などの不確実性を考慮した旅行計画を評価するための大規模ベンチマークです。インド504都市の実データと、遅延分布・混雑密度パターンを組み込み、生成された旅程がストochasticな状況でもどれだけ頑健かを評価します。



**新規性**
従来の静的な制約充足評価ではなく、不確実性下での頑健性を測るためにBAS、CATS、TDASの3指標を提案した点が新規です。



**Tags:** 旅行計画, ベンチマーク, 不確実性, 大規模言語モデル, 頑健性評価
...
### 13. Improving Health Literacy through Lay Summarization of Radiological Reports: An Evaluation of BioNER and Retrieval-Augmented Generation
- arXiv: [2609.02396](https://arxiv.org/abs/2609.02396)
- PDF: [link](https://arxiv.org/pdf/2609.02396.pdf)
- Published: 2026-09-02 19:06 JST
- Updated: 2026-09-02 19:06 JST
...
**日本語要約**
放射線レポートは専門用語が多く患者にとって理解しづらいため、本研究では患者向けの平易な要約生成におけるRAGとNERの効果を比較した。QwenとBioBARTのfew-shot版・fine-tuned版で評価した結果、NERは一貫して可読性と全体品質を改善し、RAG単独では有益性がなく、場合によっては幻覚を増やした。



**新規性**
放射線レポートの平易化において、RAGよりもエンティティ認識に基づく抽出が主要な改善要因であることを示し、特にfine-tuned BioBART+NERが最良性能を示した。



**Tags:** radiology reports, lay summarization, NER, RAG, health literacy
...
### 14. Scalable Direction-Following TTS via Voice Impression-Guided Pseudo Triplet Construction
- arXiv: [2609.02623](https://arxiv.org/abs/2609.02623)
- PDF: [link](https://arxiv.org/pdf/2609.02623.pdf)
- Published: 2026-09-02 23:02 JST
- Updated: 2026-09-02 23:02 JST
...
**日本語要約**
本研究は、参照発話に対する指示文に従って新しい発話を生成する direction-following TTS を扱い、話者同一性と言語内容を保ちながら発話の表現を変えることを目的としています。学習データ不足に対して、印象制御可能なTTSで制御されたスタイル変化を作り、LLMで印象差から自然言語の指示文を生成することで、(参照発話, 指示文, 変更後発話) の疑似トリプレットを大規模に構築します。



**新規性**
印象差に基づく自然言語指示の生成と、印象制御TTSを組み合わせて疑似トリプレットをスケーラブルに作成し、direction-following TTSの学習を可能にした点です。



**Tags:** TTS, speech synthesis, style transfer, LLM, speaker preservation
