...
Generated at: 2026-08-13 08:55 JST
Run ID: d63b3bbc-5a15-4da9-b644-130326c340e4
...
- arXiv: [2608.11027](https://arxiv.org/abs/2608.11027)
- PDF: [link](https://arxiv.org/pdf/2608.11027.pdf)
- Published: 2026-08-12 00:07 JST
- Updated: 2026-08-12 00:07 JST
...
**日本語要約**
32の大規模言語モデルを、1万件の共通プロンプトへの応答に基づいて埋め込み・比較し、モデル間の行動的な距離や世代間の変化を可視化・分析した研究です。3種類の補完的な不一致尺度を用いることで、モデルファミリーが一貫したクラスターを形成し、時間とともにファミリー間距離が縮小すること、また最近の推論志向モデルでは応答分布が比較的コンパクトであることを示しています。



**新規性**
応答の行動差を、整列付き平均距離・PCA要約・Gromov--Wasserstein距離という3つの異なる尺度で統一的に捉え、ラベル不要でモデル進化の幾何学的変化を比較可能にした点が新規です。



**Tags:** large language models, behavioral analysis, model comparison, representation geometry, drift
...
- PDF: [link](https://arxiv.org/pdf/2608.11047.pdf)
- Published: 2026-08-12 00:18 JST
- Updated: 2026-08-12 00:18 JST
...
**日本語要約**
V-FiLLMは、実行可能な計算木を用いて実テーブルに基づく金融推論ベンチマークを自動生成する枠組みで、正解が構成的に保証された問題を大規模かつ低コストで作成できる。4つの難易度軸を制御可能で、公開モデルでは推論深度の増加や数値摂動により精度低下が大きいことが示された。



**新規性**
モデルをラベル付けに介在させず、検証済みの計算木から正解保証付きの金融推論データを生成できる点が新規である。



**Tags:** financial reasoning, benchmark, table QA, LLM evaluation, synthetic data
...
- PDF: [link](https://arxiv.org/pdf/2608.11167.pdf)
- Published: 2026-08-12 02:28 JST
- Updated: 2026-08-12 02:28 JST
...
**日本語要約**
既存のMLLMは画像全体と長文説明の対応付けに依存するため、複数物体とテキスト実体の対応が曖昧になりやすいという課題があります。本研究は、テキスト中の実体を対応する視覚オブジェクトに置き換えて視覚と言語を交互に混在させる事前学習手法MMCSを提案し、明示的な物体レベルの整合を学習させます。



**新規性**
コードスイッチングに着想を得て、視覚オブジェクトを文中に直接挿入することで、画像レベルではなく物体レベルの対応を明示的に監督する事前学習パラダイムを提案した点が新規です。



**Tags:** multimodal learning, vision-language alignment, object grounding, pretraining, MLLM
...
### 4. TEAMMix: Taxonomy Enrichment Augmentation and Minority-augmented Mixing Strategy for LLM-enhanced Weak-Supervised Hierarchical Text Classification
- arXiv: [2608.11044](https://arxiv.org/abs/2608.11044)
- PDF: [link](https://arxiv.org/pdf/2608.11044.pdf)
- Published: 2026-08-12 00:16 JST
- Updated: 2026-08-12 00:16 JST
...
**日本語要約**
本論文は、階層的テキスト分類における複雑なラベル階層とクラス不均衡の課題に対し、LLMを用いた弱教師ありデータ拡張フレームワークTEAMMixを提案する。キーワード生成とコーパスマイニングでラベル階層を意味的に拡張し、さらにLLMで擬似サンプルを生成してロングテール問題を緩和する。



**新規性**
ラベル階層の意味的拡張と、少数クラスを意識した擬似サンプル生成・信頼度ベース再サンプリングを組み合わせ、LLM生成データの品質と分類性能を高めた点が新規である。



**Tags:** 階層的テキスト分類, 弱教師あり学習, データ拡張, 大規模言語モデル, クラス不均衡
...
- arXiv: [2608.11138](https://arxiv.org/abs/2608.11138)
- PDF: [link](https://arxiv.org/pdf/2608.11138.pdf)
- Published: 2026-08-12 01:59 JST
- Updated: 2026-08-12 01:59 JST
...
**日本語要約**
本論文は、LLMのトークン予測における不確実性が、出力分布の広がりだけでなく、注意経路を摂動したときに予測がどれだけ脆弱かにも表れると主張する。提案手法ASMIは注意ヘッドをマスクしてサブネットワーク間のBALD相互情報量を測り、grounded QAでは単一パスのconfidenceやentropyよりも誤り予測に有用な情報を追加し、特に「自信があるが脆い」予測で効果を示した。



**新規性**
注意経路の脆弱性を不確実性シグナルとして定式化し、訓練不要で推定するASMIを提案した点が新規である。



**Tags:** large language models, uncertainty estimation, attention heads, question answering, mutual information
...
- arXiv: [2608.11146](https://arxiv.org/abs/2608.11146)
- PDF: [link](https://arxiv.org/pdf/2608.11146.pdf)
- Published: 2026-08-12 02:05 JST
- Updated: 2026-08-12 02:05 JST
...
**日本語要約**
本研究は、英語で整備されたLLMの安全性アラインメントが、低資源言語にそのまま一般化するという前提を検証した。Twi、Hausa、Amharic、Swahiliを対象に、翻訳と文化的に स्थानीय化したプロンプトを含むLoDNAを用いて評価し、クロスリンガルな安全転移は非常に限定的であることを示した。



**新規性**
生成結果だけでなく隠れ状態の拒否表現を調べる潜在幾何学的フレームワークを提案し、低資源言語では意味は整合していても安全機構へ十分に接続されないことを示した。



**Tags:** LLM安全性, クロスリンガル転移, 低資源言語, 隠れ状態解析, 多言語NLP
...
### 7. ReRound: Reconstructive Rounding to Resolve Midpoint Ambiguity in Calibration-Free LLM Quantization
- arXiv: [2608.11045](https://arxiv.org/abs/2608.11045)
- PDF: [link](https://arxiv.org/pdf/2608.11045.pdf)
- Published: 2026-08-12 00:18 JST
- Updated: 2026-08-12 00:18 JST
...
**日本語要約**
ReRoundは、標準的なround-to-nearest量子化で生じる中点付近の曖昧さを解消するための事後学習型量子化手法です。事前学習済みLLMから条件付き拡散モデルで低ビット重みの連続的な再構成を行い、その情報を使って中点近傍の重みの丸め方向を決めます。3-bit/4-bit量子化で標準RTNや多くのcalibration-free手法より高精度で、校正不要かつ推論時オーバーヘッドもありません。



**新規性**
拡散モデルによる重み再構成を、量子化中点付近の丸め方向の判定に用いる点が新規です。



**Tags:** LLM量子化, post-training quantization, 拡散モデル, 低ビット量子化, calibration-free
...
### 8. Templated or fully Synthetic? Prompt construction as a confound in measuring LLM political stance beyond writing assistance
- arXiv: [2608.11008](https://arxiv.org/abs/2608.11008)
- PDF: [link](https://arxiv.org/pdf/2608.11008.pdf)
- Published: 2026-08-11 23:55 JST
- Updated: 2026-08-11 23:55 JST
...
**日本語要約**
本研究は、LLMの政治的スタンス測定において、従来のテンプレート化されたプロンプトが評価上の人工物として機能しうる点を指摘し、writing assistance以外に情報探索と意見共有タスクへIssueBenchを拡張した。さらに、実プロンプト、テンプレート、LLM生成の完全合成プロンプトを比較し、合成プロンプトは人間・LLMの両方から実在性が高く、意図やスタンスも明確だと評価された。ケーススタディでは、テンプレートと合成プロンプトで同一モデルのスタンス推定が系統的に異なり、特に中立的な表現でテンプレートが偏りを過大評価することが示された。



**新規性**
LLM生成による完全合成プロンプトを用いて、テンプレート化プロンプトがLLMの政治的スタンス推定を歪める交絡要因になりうることを実証的に示した。



**Tags:** LLM, political stance detection, prompt construction, evaluation bias, IssueBench
...
- arXiv: [2608.11030](https://arxiv.org/abs/2608.11030)
- PDF: [link](https://arxiv.org/pdf/2608.11030.pdf)
- Published: 2026-08-12 00:08 JST
- Updated: 2026-08-12 00:08 JST
...
**日本語要約**
本論文は、特許文書の複雑さや専門用語の多さにより従来手法では難しかった特許検索・マッチングに対して、LLMを用いた自己知識RAGフレームワークを提案する。提案手法は、特許クエリから重要な技術エンティティと階層的なオントロジー構造を自動抽出してクエリ拡張を行い、FAISSによる検索と生成的マッチングを組み合わせて精度向上を図る。



**新規性**
LLMが特許クエリから技術エンティティと階層的オントロジーを自律的に構築し、それを用いて検索精度を高める自己知識RAG枠組みを提案した点。



**Tags:** patent retrieval, RAG, large language models, information retrieval, query expansion
...
### 10. Data Attribution of Emergent Misalignment with Persona Features
- arXiv: [2608.11025](https://arxiv.org/abs/2608.11025)
- PDF: [link](https://arxiv.org/pdf/2608.11025.pdf)
- Published: 2026-08-12 00:05 JST
- Updated: 2026-08-12 00:05 JST
...
**日本語要約**
本研究は、細いタスクへの微調整で生じる emergent misalignment（EM）について、SAEベースのモデル差分を用いて、ジャイルブレイク的ペルソナ、皮肉、欺瞞、操作に関する特徴が強化され、安全性やアシスタント同一性に関する特徴が抑制されることを示した。さらに、個別特徴の操作でEMを双方向に制御できることを確認した。



**新規性**
1百万件の事前学習Web文書から因果的特徴に対応する記述を抽出し、意味的に関連する人間記述だけではEMを安定して誘発できず、合成された指示応答形式や応答構造が重要であることを示した。



**Tags:** emergent misalignment, persona features, sparse autoencoder, data attribution, language model fine-tuning
...
### 11. Scheduling Mixed RL Rollouts Beyond Prefix Locality
- arXiv: [2608.11152](https://arxiv.org/abs/2608.11152)
- PDF: [link](https://arxiv.org/pdf/2608.11152.pdf)
- Published: 2026-08-12 02:10 JST
- Updated: 2026-08-12 02:10 JST
...
**日本語要約**
大規模言語モデルのRL後学習において、RLVR・RLHF・agentic rolloutが混在する非同期推論サービスでは、prefix共有だけではKV-cache競合を制御できないことを指摘しています。提案手法MISA-Tは、セッション受け入れ、KV容量配分、滞在時間を考慮したKV会計を組み合わせ、混合ワークロードの比率を保ちながらスループットと反復時間を改善します。



**新規性**
prefix locality だけでなく、異種rolloutのKV-cache滞在時間とワークロード比率まで考慮したrouting-layer admission policyを提案した点です。



**Tags:** reinforcement learning, LLM serving, KV cache, scheduling, throughput
...
### 12. SCOUT: Symmetric Consensus Outlier Detection for Failure Localization in LLM Pre-Training
- arXiv: [2608.11034](https://arxiv.org/abs/2608.11034)
- PDF: [link](https://arxiv.org/pdf/2608.11034.pdf)
- Published: 2026-08-12 00:12 JST
- Updated: 2026-08-12 00:12 JST
- Authors: Zhuang Wang
- Categories: cs.DC, cs.LG
- Score: 12.75
- Match reasons:
...
**日本語要約**
LLM事前学習では、同期処理により1つのランクの停止や遅延、数値誤りがジョブ全体の症状として現れ、原因特定が難しくなります。SCOUTは、同等な複製間の厳密多数決に基づく一致判定で外れ値ランクを特定し、ハング時にも動作するCPU観測器と、実行中の状態を保ったまま再現するin-situ replayを組み合わせて障害を局所化します。



**新規性**
新規性は、進捗・タイミング・数値証拠を整合させたうえで、C3による多数決コンセンサスで外れ値を検出し、さらに再生実行でストラグラやSDCを実環境条件下で切り分ける統一的なランタイム障害局所化枠組みを提案した点です。



**Tags:** LLM事前学習, 障害局所化, 外れ値検出, 分散学習, silent data corruption
...
### 13. Workflow Cards: Structured Summaries of Workflow Executions Using Provenance Data
- arXiv: [2608.11022](https://arxiv.org/abs/2608.11022)
- PDF: [link](https://arxiv.org/pdf/2608.11022.pdf)
- Published: 2026-08-12 00:02 JST
- Updated: 2026-08-12 00:02 JST
...
**日本語要約**
Model CardsやData Cardsが静的な資産の文書化に偏っているのに対し、本論文はワークフロー実行に関するプロヴェナンスデータを人間とLLMが読める形で要約するWorkflow Cardsを提案する。実行時のデータ準備、パラメータ選択、実行挙動、資源利用、途中変換など、既存カードでは欠けていた情報を扱えることを示した。さらに、Workflow CardsはスキーマベースのプロヴェナンスDB問い合わせよりも回答品質を高めることを評価で示した。



**新規性**
ワークフロー実行のプロヴェナンス情報を、質問駆動で設計した構造化カードとして要約し、LLMと人間の両方が利用しやすい文書形式にした点が新規である。



**Tags:** provenance, workflow execution, documentation, large language models, reproducibility
...
### 14. From Interpretability to Control: Insights from Six Years of the TrustNLP Workshop
- arXiv: [2608.11171](https://arxiv.org/abs/2608.11171)
- PDF: [link](https://arxiv.org/pdf/2608.11171.pdf)
- Published: 2026-08-12 02:30 JST
- Updated: 2026-08-12 02:30 JST
...
**日本語要約**
TrustNLPワークショップの6年間・144本の論文を対象に、信頼性NLPの研究潮流を6つの信頼次元で整理し、静的モデルの事後的な解釈から生成モデルの機構的理解と制御へと関心が移ったことを示した。特に、初期の高性能チャットモデルの登場で信頼性の各次元が同時に活性化し、その後は真実性と安全性への関心が強まったこと、また公平性は一貫して重要で、説明可能性は一度減少した後に2026年に再び増加したことを報告している。



**新規性**
TrustNLPの全144本を体系的に分類し、信頼性研究の長期的変化を6次元で可視化した点が新規性である。



**Tags:** 自然言語処理, 信頼性, 解釈可能性, 生成モデル, ワークショップ分析
...
### 15. Long-Horizon AI Research for Grothendieck Constant: A Case Study in Human-AI Mathematical Collaboration
- arXiv: [2608.11195](https://arxiv.org/abs/2608.11195)
- PDF: [link](https://arxiv.org/pdf/2608.11195.pdf)
- Published: 2026-08-12 02:53 JST
- Updated: 2026-08-12 02:53 JST
...
### 16. Test-Time Self-Evolving GUI Visual Grounding via Reflection-Guided On-Policy Self-Distillation
- arXiv: [2608.11191](https://arxiv.org/abs/2608.11191)
- PDF: [link](https://arxiv.org/pdf/2608.11191.pdf)
- Published: 2026-08-12 02:50 JST
- Updated: 2026-08-12 02:50 JST
...
**日本語要約**
本研究は、GUI Visual Groundingモデルがデプロイ後に未知のインターフェースへ適応できるようにするTest-Time Self-Evolving枠組みを提案する。探索・評価・反省・内在化の閉ループを構成し、MLLMベースのReflectorとReflection-Guided On-Policy Self-Distillationにより、失敗探索から得た反省をモデル重みに反映する。



**新規性**
テスト時適応のGUI visual groundingにおいて、on-policy self-distillationを用いて失敗探索の反省を学習へ取り込む点が新規である。



**Tags:** GUI visual grounding, test-time adaptation, self-distillation, multimodal LLM, reflection
...
### 17. ConVAWG: A Retrieval-Grounded Framework for Controlled Synthetic Dialogue Generation in Violence Against Women and Girls
- arXiv: [2608.11200](https://arxiv.org/abs/2608.11200)
- PDF: [link](https://arxiv.org/pdf/2608.11200.pdf)
- Published: 2026-08-12 02:57 JST
- Updated: 2026-08-12 02:57 JST
...
**日本語要約**
本研究は、暴力を伴う会話を単文の毒性ではなく、関係性と時間的推移を持つ多ターン対話として扱うための合成対話生成フレームワークConVAWGを提案する。人物設定、人口統計パターン、犯罪定義、Domestic Homicide Review事例の検索結果を用いてシナリオを構築し、階層的なイベント時系列から多場面のロールプレイ対話を生成する。



**新規性**
検索に基づくシナリオ構築と階層的イベントタイムライン生成、さらに発話単位の毒性制御を組み合わせて、VAWGの多ターン対話を制御可能に生成する点が新しい。



**Tags:** 対話生成, 合成データ, 有害対話, 検索拡張, VAWG
