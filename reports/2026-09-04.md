...
Generated at: 2026-09-04 09:57 JST
Run ID: 374de3db-bb66-485e-bf2d-8a0a07c109f0
...
- PDF: [link](https://arxiv.org/pdf/2609.02805.pdf)
- Published: 2026-09-03 01:43 JST
- Updated: 2026-09-03 01:43 JST
...
**日本語要約**
本論文は、5G/6Gネットワークにおける通信障害の根本原因分析（RCA）に対して、LLMをそのまま用いると幻覚や不安定な推論が生じやすい点を指摘し、関連研究の整理とともに、証拠に基づく診断のための構造化推論フレームワークを提案する。提案手法は、異種テレメトリを標準化された文脈に整理し、診断時の決定経路推論を強制し、最終的に根拠付き説明を生成することで、TeleLogsとTelecomTSの2つの5G RCAデータセットで精度と一貫性の向上を示した。



**新規性**
テレコムRCAにLLMを適用する際、構造化された証拠整合型推論を明示的に組み込むフレームワークを提案し、クロスデータセットで有効性を示した点が新規である。



**Tags:** LLM, telecom RCA, structured reasoning, evidence grounding, 5G
...
### 2. User Feedback Provides a Unique Signal that LLMs Can not Detect
- arXiv: [2609.02859](https://arxiv.org/abs/2609.02859)
- PDF: [link](https://arxiv.org/pdf/2609.02859.pdf)
- Published: 2026-09-03 02:42 JST
- Updated: 2026-09-03 02:42 JST
...
**日本語要約**
本研究は、ユーザーフィードバックがLLM改善に有効な学習信号であり、従来その有効性が低く見積もられていたのは評価手法に系統的な偏りがあるためだと主張する。合成データと自然データの両方で、フィードバックを用いた修正版は対象問題をベースラインより高い率で解決した。さらに、LLMによる評価者は、フィードバックによってのみ正しく修正された応答を見落とし、劣るベースライン出力を好む傾向があることを示した。



**新規性**
フィードバックの有効性を検証するために真の正解を持つ合成データと自然データを用い、LLM評価のバイアスがフィードバックの価値を過小評価していることを明らかにした。



**Tags:** LLM, user feedback, evaluation bias, model revision, cs.CL
...
### 3. CORAL: An LLM-Native Harness for Production Recommender Systems
- arXiv: [2609.02730](https://arxiv.org/abs/2609.02730)
- PDF: [link](https://arxiv.org/pdf/2609.02730.pdf)
- Published: 2026-09-03 00:40 JST
- Updated: 2026-09-03 00:40 JST
...
**日本語要約**
本論文は、ライブな推薦システムに対してLLMエージェントが観測・推論・ツール実行を繰り返し、測定結果を次の意思決定に反映する閉ループ型のハーネスCORALを提案する。2つの大規模ソーシャルプラットフォームでのA/B実験により、片方では追加の配信コストなしにエンゲージメントを改善し、もう片方ではエンゲージメントを維持したまま配信コストを削減した。



**新規性**
LLMを推薦システムの継続的最適化におけるエージェントとして位置づけ、制約付きの運用予算内で改善を反復的に学習する閉ループを実運用環境で実現した点が新しい。



**Tags:** 推薦システム, LLMエージェント, A/Bテスト, 最適化, 運用コスト
...
- arXiv: [2609.02754](https://arxiv.org/abs/2609.02754)
- PDF: [link](https://arxiv.org/pdf/2609.02754.pdf)
- Published: 2026-09-03 00:55 JST
- Updated: 2026-09-03 00:55 JST
...
**日本語要約**
医療質問応答において、誤解を招く文脈が大規模言語モデルの判断をどのように汚染するかを、MedMisBenchの医療推論サブセットで調べた研究です。捏造された証拠と単なる断定の2種類の誤導を注入し、モデルの脆弱性、開示率、推論への影響の仕方、そして誤判断の監視可能性を比較しています。



**新規性**
誤導文脈の中でも、モデルが最も影響を受けやすい単なる断定が最も開示されにくく、開示された推論トレースでのみ比較的高精度に検出できることを示した点が新規です。



**Tags:** medical QA, large language models, misleading context, reasoning traces, monitoring
...
- PDF: [link](https://arxiv.org/pdf/2609.02649.pdf)
- Published: 2026-09-02 23:24 JST
- Updated: 2026-09-02 23:24 JST
...
**日本語要約**
Loomは、ノイズや矛盾を含む自由記述の診断仮説を埋め込み空間に写像し、反復的な重み再計算で合意を求めたうえで、1回の軽量LLM要約に接続する自由文コンセンサス手法です。OpenRCAで評価し、単一LLMエージェントと比べて精度と効率の両面で競争力を示し、全データセットで1件あたり1回のLLM呼び出しに抑えました。



**新規性**
離散クラスに限られる従来の弱教師あり学習と、重い単一LLMエージェントの間を埋めるため、自由記述の診断仮説を埋め込み空間で統合し、中心ベースの反復重み付けで合意を形成する点が新しいです。



**Tags:** Root Cause Analysis, consensus learning, embedding space, LLM efficiency, weak supervision
...
### 6. Door-in-the-Face Requests and Refusal Behaviour in Large Language Models
- arXiv: [2609.02707](https://arxiv.org/abs/2609.02707)
- PDF: [link](https://arxiv.org/pdf/2609.02707.pdf)
- Published: 2026-09-03 00:08 JST
- Updated: 2026-09-03 00:08 JST
- Authors: Til Jordan
...
**日本語要約**
人間の説得手法である door-in-the-face technique が大規模言語モデルに有効かを、9つの商用モデルで検証した研究である。大きな要求を拒否した直後に小さな関連要求を出すと、Anthropic系では応答率が上がる一方、OpenAIやGoogle系では逆に下がるなど、効果はモデル家族によって異なった。



**新規性**
拒否後の小さな要求への応答変化が、モデル家族ごとに正負逆転しうることを示し、さらに要求内容の書き換えで拒否を回避できる場合が多いことを示した点が新規である。



**Tags:** large language models, persuasion, refusal behavior, prompting, safety
...
- PDF: [link](https://arxiv.org/pdf/2609.02817.pdf)
- Published: 2026-09-03 02:03 JST
- Updated: 2026-09-03 02:03 JST
...
**日本語要約**
本論文は、RLVRにおける粗い結果報酬の代わりに、推論過程の最初の誤りに着目した報酬整形手法Cliffを提案する。各ロールアウトを正しいprefixと誤ったsuffixに分け、正しい部分には正の優位度、誤り以降には負のフィードバックを与えることで、LLMの推論学習を改善する。12の設定で評価し、既存のon-policy distillationや標準GRPOより性能向上を示した。



**新規性**
各ロールアウトの「最初の誤り」をオフ・ザ・シェルフLLMで特定し、その位置で推論過程を二分してトークンレベルの報酬に変換する点が新しい。



**Tags:** reinforcement learning, LLM, reward shaping, reasoning, process supervision
...
### 8. Post-Training Language Models for Gold-Medal Performance in Coding Competitions
- arXiv: [2609.02849](https://arxiv.org/abs/2609.02849)
- PDF: [link](https://arxiv.org/pdf/2609.02849.pdf)
- Published: 2026-09-03 02:33 JST
- Updated: 2026-09-03 02:33 JST
...
**日本語要約**
本研究は、競技プログラミング向けに大規模な問題収集、合成推論トレース、SFT、RLを組み合わせた後学習パイプラインを提案し、IOI/ICPCのような難関設定での性能向上を示した。さらに、推論時に解候補を反復生成・評価・改善するGenCorrectを導入し、IOI 2025およびIOI 2026で金メダル基準や人間最高得点を上回る結果を報告している。



**新規性**
競技プログラミング特化の後学習とテスト時計算戦略GenCorrectを組み合わせ、IOI問題セットで最高得点の人間を上回るAIシステムを実現した点が新規である。



**Tags:** 競技プログラミング, 大規模言語モデル, 強化学習, SFT, テスト時推論
...
### 9. From Tokens to Semantics: Leveraging Complementary Signals for Hallucination Detection in Black-Box LLMs
- arXiv: [2609.02679](https://arxiv.org/abs/2609.02679)
- PDF: [link](https://arxiv.org/pdf/2609.02679.pdf)
- Published: 2026-09-02 23:50 JST
- Updated: 2026-09-02 23:50 JST
...
**日本語要約**
本研究は、ブラックボックスLLMにおける幻覚検出のために、意味的エントロピーとトークン確率に基づく不確実性という2つの補完的信号を比較・統合する手法を検討している。7つのベンチマークと4つのモデルで評価し、教師ありのStackedが多くの条件で最良性能を示す一方、教師なしのTopKとCoCoAも競争力があることを示した。



**新規性**
トークンレベルの不確実性を複数サンプルに集約するTopK、意味的不一致を組み合わせるCoCoA、さらに意味的不確実性と広範なトークン特徴を統合するGated/Stackedを提案し、ブラックボックス環境での幻覚検出を拡張した。



**Tags:** hallucination detection, black-box LLM, semantic entropy, uncertainty estimation, benchmark evaluation
...
### 10. Eliciting ESG Preferences for Reinforcement Learning-Based Portfolio Optimization
- arXiv: [2609.02677](https://arxiv.org/abs/2609.02677)
- PDF: [link](https://arxiv.org/pdf/2609.02677.pdf)
- Published: 2026-09-02 23:48 JST
- Updated: 2026-09-02 23:48 JST
...
**日本語要約**
本研究は、従来の単一ESG評価機関に依存するRLベースのポートフォリオ最適化の限界に対し、3つのESG機関の評価を同時に扱う多目的強化学習として定式化し、Sharpe比と総合ESGスコアに基づくポートフォリオ比較から人間の選好を推定する枠組みを提案する。歴史的市場データを用いた評価では、LLMで模擬した地域別のポートフォリオマネージャーの背景によって選好重みが大きく変化し、欧州系はESG整合性を、テキサス系はリスク調整後収益をより重視する傾向が示された。



**新規性**
Gaussian Processesによる選好 elicitation を多目的強化学習のポートフォリオ最適化に組み込み、複数ESG機関の評価差と人間の潜在的効用を同時に扱える点が新規である。



**Tags:** 多目的強化学習, ESG投資, ポートフォリオ最適化
...
### 11. DiscoSign: Discourse-Aware Text to Sign Language Gloss Translation
- arXiv: [2609.02796](https://arxiv.org/abs/2609.02796)
- PDF: [link](https://arxiv.org/pdf/2609.02796.pdf)
- Published: 2026-09-03 01:31 JST
- Updated: 2026-09-03 01:31 JST
...
**日本語要約**
DiscoSignは、従来の文単位の翻訳では捉えにくい手話理解に重要な談話現象を考慮した、英語テキストからASLグロスへの翻訳手法です。空間照応、Question-Answer Clauses（QACs）、概念とグロスの一貫性を扱うモジュール型LLM翻訳枠組みを提案し、談話レベルの品質を評価する新しい指標群も導入しています。実験では、文単位翻訳よりも空間的一貫性とエンティティ追跡が改善し、単文翻訳品質も競争力を保ちました。



**新規性**
談話レベルのテキストから手話グロスへの翻訳を体系化した初の枠組みであり、対応する評価方法も併せて提案した点です。



**Tags:** sign language translation, discourse processing, LLM, coreference resolution, evaluation metrics
...
- PDF: [link](https://arxiv.org/pdf/2609.02702.pdf)
- Published: 2026-09-03 00:06 JST
- Updated: 2026-09-03 00:06 JST
...
**日本語要約**
本論文は、長文脈推論では後から得られるタスク状態が重要になる一方、因果的なTransformerではその状態を先に与える方が有利になりうることを、conditional state update tasksとして定式化する。これに基づき、推論トレースをタスク状態のテキスト代理として長文脈の前に置き、再読みに活用するTrace as Stateを提案する。3つのモデルと3つの長文脈データセットで、Trace as StateはTrace Appendより26/27の組み合わせで性能が上回った。



**新規性**
推論トレースを文脈の前に配置して再読みに使うことで、因果的Transformerのまま長文脈推論を改善する手法を提案した点が新しい。



**Tags:** long-context reasoning, transformer, reasoning traces, causal models, cs.CL
...
- PDF: [link](https://arxiv.org/pdf/2609.02786.pdf)
- Published: 2026-09-03 01:19 JST
- Updated: 2026-09-03 01:19 JST
...
**日本語要約**
LLMベースのエージェントは、基盤モデルだけでなく環境とのやり取りに使うハーネスにも安全リスクがあるため、著者らは経験に基づいてハーネスとポリシーを継続的に共同進化させるSafeEvolveを提案した。完了したオンポリシー軌跡から得た安全経験を用いて、ハーネス側では安全プロンプトや階層スキルを局所的かつ可逆的に更新し、ポリシー側ではSFTとRLの2段階で安全行動を強化する。エージェント安全ベンチマークでは、既存手法より安全性と有用性のトレードオフが良い結果を示した。



**新規性**
軌跡レベルの安全経験を、監査可能で可逆なハーネス更新と、ハーネス活用を組み込んだSFT-RLの両方に反映するハーネス・ポリシー共同進化枠組みを提案した点。



**Tags:** LLMエージェント, 安全性アラインメント, ハーネス, 強化学習, SFT
...
- PDF: [link](https://arxiv.org/pdf/2609.02852.pdf)
- Published: 2026-09-03 02:37 JST
- Updated: 2026-09-03 02:37 JST
...
**日本語要約**
本論文は、LLMの外部出力や機械的に抽出した言語特徴が、モデル内部の実際の計算を必ずしも正確に表さない状況を「linguistic illegibility」と定義し、そのセキュリティ上の含意を論じる。特に、chain-of-thought監視や自己批評、言語的特徴のプロービングのようにモデルの言語的自己報告に依存する防御は完全には信頼できず、言語状態の読取りに依存しない隔離が必要だと主張する。



**新規性**
LLMの言語的自己報告の不確実性を「linguistic illegibility」として整理し、これにより言語ベースの監視だけでは不十分で、taint trackingを中心とした隔離機構が必要であることをセキュリティの観点から体系的に示した点が新規である。



**Tags:** LLM security, sandboxing, taint tracking, interpretability, chain-of-thought
...
### 15. ShallowStream: Index Shallow then Answer Deep for Streaming Video Understanding
- arXiv: [2609.02780](https://arxiv.org/abs/2609.02780)
- PDF: [link](https://arxiv.org/pdf/2609.02780.pdf)
- Published: 2026-09-03 01:14 JST
- Updated: 2026-09-03 01:14 JST
...
**日本語要約**
ShallowStreamは、ストリーミング動画理解において、MLLMの浅い層を使ってフレーム符号化と検索用インデックス構築を同時に行う枠組みです。ストリーム処理中は浅層KVキャッシュで軽量な常時インデックスを維持し、質問時には浅層の注意スコアに基づいて文脈フレームを選択して回答します。



**新規性**
モデルの深さに着目し、深い層を毎回実行せずに浅い層だけでインデックス化と検索を行う点が新規です。



**Tags:** streaming video understanding, multimodal large language model, KV cache, frame retrieval, efficiency
...
### 16. Bilevel Coordinated Reflection: A Game-Theoretic Approach to Multi-Agent LLM Systems
- arXiv: [2609.02750](https://arxiv.org/abs/2609.02750)
- PDF: [link](https://arxiv.org/pdf/2609.02750.pdf)
- Published: 2026-09-03 00:50 JST
- Updated: 2026-09-03 00:50 JST
...
**日本語要約**
本論文は、マルチエージェントLLMシステムにおけるオーケストレータとワーカーの相互作用を二層の協調ゲームとして定式化し、分解品質が局所更新ゲームの均衡ずれを左右することを示します。さらに、反省（reflection）を意味記憶状態上の確率的移動として解析し、テキストのみを観測するゲートの限界と、環境に基づく評価ゲートの有効性を理論的に示します。



**新規性**
環境に基づく評価リスクが厳密に低下した場合のみ候補記憶を受理する Stochastic Reflective Memory Ascent (SRMA) を提案し、その収束率と最適性、さらにテキストのみのゲートでは一様改善が不可能であることを示した点が新規です。



**Tags:** multi-agent LLM, game theory, reflection, memory update, theoretical analysis
...
### 17. Incremental Pooled LLM Evaluation for Cost-Effective Retrieval Model Selection
- arXiv: [2609.02745](https://arxiv.org/abs/2609.02745)
- PDF: [link](https://arxiv.org/pdf/2609.02745.pdf)
- Published: 2026-09-03 00:47 JST
- Updated: 2026-09-03 00:47 JST
...
**日本語要約**
本研究は、RAGシステム向けの検索モデル選択において、LLMによる pooled evaluation を用いて複数システムの文書集合を共通の基準で評価する手法を提案する。新しい候補システムが追加された際は、そのシステムが新たに持ち込む文書だけを判定してプールを拡張し、既存の判定結果を再利用することで、再評価コストを抑える。4つのベンチマークと実運用の金融ニュースQAシステムで有効性を示し、評価コストの削減と順位の高い一致を報告している。



**新規性**
新規性は、LLM判定を増分的に再利用して pooled evaluation を拡張し、候補追加時に既存文書の再判定なしで検索モデル比較を継続できる点にある。



**Tags:** retrieval evaluation, LLM, RAG, incremental evaluation, cost reduction
...
### 18. Unfolding the Leech Lattice: Fused Multi-Shell Decoding and VRAM Layouts for 2-Bit LLM Weights
- arXiv: [2609.02652](https://arxiv.org/abs/2609.02652)
- PDF: [link](https://arxiv.org/pdf/2609.02652.pdf)
- Published: 2026-09-02 23:26 JST
- Updated: 2026-09-02 23:26 JST
...
**日本語要約**
本論文は、Leech lattice に基づく2-bit LLM量子化について、これまで実装が見当たらなかった multi-shell デコーダをGPU向けに実装し、fused dequantize-plus-matvec により batch 1 の decode-phase GEMV を評価している。さらに、VRAM上のレイアウト設計が性能に与える影響を4種類のbit-exact layoutで比較し、bit plane 方式が one-hot mask よりサイズ・速度の両面で有利であることを示している。



**新規性**
301クラスのLeech lattice codebook全体を扱うmulti-shellデコーダと、VRAMレイアウトを含めた2-bit LLM servingの実装・性能評価を提示した点が新しい。



**Tags:** LLM量子化, Leech lattice, GPU最適化, GEMV, VRAMレイアウト
...
- arXiv: [2609.02771](https://arxiv.org/abs/2609.02771)
- PDF: [link](https://arxiv.org/pdf/2609.02771.pdf)
- Published: 2026-09-03 01:07 JST
- Updated: 2026-09-03 01:07 JST
...
**日本語要約**
本研究は、training data attribution（TDA）で選ばれた影響力のある学習例が、通常の重み付け介入では十分な行動変化を示さない問題を検討する。4つのオープンウェイトLLMを用いて、同じ影響例に対する重み付けと応答の書き換えを比較し、書き換えの方がより強く持続的で双方向的な行動変化を生むことを示した。



**新規性**
Influence functionsで選んだ例に対し、重み付けではなく応答書き換えを行う「influence-guided response rewriting」を提案し、TDAの介入価値を介入手法込みで評価すべきことを示した。



**Tags:** training data attribution, influence functions, large language models, data intervention
